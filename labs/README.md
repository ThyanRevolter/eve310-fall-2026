...
folder is self-contained: notebooks, cheat sheets, data, and figures. Lab slides stay on Canvas. Folders are published the week
...
5. **File > Download > Download .ipynb** and upload the activity to Gradescope (optional, for feedback; the lab quiz on Canvas is graded)
